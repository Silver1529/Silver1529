<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0066FF&height=200&section=header&text=Miguel%20Bahia&fontSize=70&animation=fadeIn&fontColor=BA55D3" />
</div>
...
| :--- | :--- | :--- |
| **💰 Coinnect** | Painel financeiro familiar Full Stack com segurança via env. | `NestJS`, `Next.js`, `MongoDB` |
| **🔌 CRM Extensões** | Integração de Google APIs para automação de vendas no estágio. | `React`, `Node.js`, `Chrome API` |
| **🌍 Eco Calc** | Calculadora de Pegada de Carbono para o cenário brasileiro. | `TypeScript`, `Next.js`, `Vercel` |
